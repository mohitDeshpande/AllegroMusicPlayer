...
public class MusicPlayerActivity extends Activity {
    ...
    private void setViewFromService() {
        ...
        albumArtImageView.getLayoutParams().height = albumArtImageView.getMeasuredWidth();
        ...
        Bitmap bitmap = imageLoader.loadImageSync(song.getAlbumArtUri().toString());
        if (bitmap != null) {
            Palette palette = Palette.generate(bitmap);
            window.setNavigationBarColor(palette.getVibrantColor(getResources().getColor(R.color.colorPrimaryDark)));
            window.setBackgroundDrawable(new ColorDrawable(palette.getVibrantColor(getResources().getColor(R.color.colorPrimaryDark))));
        }
    }
